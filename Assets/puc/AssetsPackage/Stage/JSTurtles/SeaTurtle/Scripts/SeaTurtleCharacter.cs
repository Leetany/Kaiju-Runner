...
namespace JSukoAnimals
{
	public class SeaTurtleCharacter : MonoBehaviour
	{
		...
		public void Swim()
		{
			...
			//seaTurtleRigid.interpolation = RigidbodyInterpolation.None;
		...
		public void UpFromWater()
		{
			...
			//seaTurtleRigid.interpolation = RigidbodyInterpolation.Extrapolate;
		...
		public void Move()
		{
			...
			if (isSwimming)
			{
				...
				seaTurtleRigid.linearVelocity = (transform.up * upDownSpeed + transform.forward) * forwardSpeed;
			}
