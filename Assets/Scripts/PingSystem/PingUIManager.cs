...
namespace WriteAngle.Ping
{
    ...
    /// </summary>
    [AddComponentMenu("WrightAngle/Ping UI Manager")]
    ...
    public class PingUIManager : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            {
                PingTarget target = activeTargetList[i];
        ...
        private void FindAndRegisterInitialTargets()
        {
            ...
            PingTarget[] allTargets = FindObjectsByType<PingTarget>(FindObjectsInactive.Include, FindObjectsSortMode.None);
            int activationCount = 0;
            foreach (PingTarget target in allTargets)
            {
        ...
        private void RegisterTarget(PingTarget target)
        {
            // HashSet.Add를 통해 추가 
        ...
        private void TryReleaseMarker(PingTarget target)
        {
        ...
        private void RemoveTargetCompletely(PingTarget target, int listIndex = -1)
        {
            // 먼저 pool에서 풀어줌
        ...
        private void HandleTargetEnabled(PingTarget target) => RegisterTarget(target);
        private void HandleTargetDisabled(PingTarget target)
        {
